...
async function addTemplate() {
  try {
    ...
    console.log("✅ Car Sale template added successfully!");
    console.log("Template details:");
    console.log(`- Name: ${templateData.name}`);
    console.log(`- Size: ${templateData.width}x${templateData.height}`);
    console.log(`- Is Template: ${templateData.isTemplate}`);
    console.log(`- Is Pro: ${templateData.isPro}`);
    console.log(`- Thumbnail: ${templateData.thumbnailUrl}`);
